module libre_top #(
 ...
 gpio_status})
    ...
    libre_bd i_libre_bd (
        ...
        .M_AXI_5_araddr (axil_sig_gen.araddr),
        .M_AXI_5_arprot (axil_sig_gen.arprot),
        .M_AXI_5_arready(axil_sig_gen.arready),
        .M_AXI_5_arvalid(axil_sig_gen.arvalid),
        .M_AXI_5_awaddr (axil_sig_gen.awaddr),
        .M_AXI_5_awprot (axil_sig_gen.awprot),
        .M_AXI_5_awready(axil_sig_gen.awready),
        .M_AXI_5_awvalid(axil_sig_gen.awvalid),
        .M_AXI_5_bready (axil_sig_gen.bready),
        .M_AXI_5_bresp  (axil_sig_gen.bresp),
        .M_AXI_5_bvalid (axil_sig_gen.bvalid),
        .M_AXI_5_rdata  (axil_sig_gen.rdata),
        .M_AXI_5_rready (axil_sig_gen.rready),
        .M_AXI_5_rresp  (axil_sig_gen.rresp),
        .M_AXI_5_rvalid (axil_sig_gen.rvalid),
        .M_AXI_5_wdata  (axil_sig_gen.wdata),
        .M_AXI_5_wready (axil_sig_gen.wready),
        .M_AXI_5_wstrb  (axil_sig_gen.wstrb),
        .M_AXI_5_wvalid (axil_sig_gen.wvalid),
