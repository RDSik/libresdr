...
create_clock -name clk_fpga_0 -period 10 [get_pins "i_libre_bd/ps_clk"]
create_clock -name clk_fpga_1 -period  5 [get_pins "i_libre_bd/delay_clk"]
...
set_false_path -from [get_pins {i_axi_ad9361_wrap/i_axi_ad9361/i_rx/i_up_adc_common/up_adc_gpio_out_int_reg[0]/C}]
set_false_path -from [get_pins {i_axi_ad9361_wrap/i_axi_ad9361/i_tx/i_up_dac_common/up_dac_gpio_out_int_reg[0]/C}]
